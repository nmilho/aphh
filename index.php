...
<main class="mt-6 pt-6">
	...
	<div class="container">
		...
		<div class="row wow fadeIn">
			...
			<!--Section: Jumbotron-->
			<section class=" mb-5 card wow fadeIn" style="background-image: url(&quot;https://mdbootstrap.com/img/Photos/Others/background3.jpg&quot;); visibility: visible; animation-name: fadeIn;">
